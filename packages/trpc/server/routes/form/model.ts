...
export const getFormFieldsOutputModel = z.array(
  z.object({
    ...
    options: z.array(z.string()).nullable().default([]).describe("The options of the form field"),
  }),
);
...
export const deleteFormFieldInputModel = z.object({
  fieldId: z.string().describe("The unique identifier of the form"),
  id: z.string().describe("The unique identifier of the form id"),
});
...
export const getFormFieldTypeOptionsOutputModel = z
  .array(z.string())
  .describe("The form field type options");
...
export const getAllFormSubmissionsOutputModel = z.array(
  z.object({
    ...
    createdAt: z
      .date()
      .nullable()
      .describe("The date and time when the form submission was created"),
  }),
);
